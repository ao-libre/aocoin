...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mAOC per kB (0.00001 AOC). This is to prepare for dropping the minimum transaction fee to 0.1 mAOC per kB (0.0001 AOC) in the next release.
