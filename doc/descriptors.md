# Support for Output Descriptors in Aocoin Core

Since Aocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Aocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Aocoin Core wallets, a convenience function `combo` is
