...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aocoin-tx [options] <hex-tx> [commands]  Update hex-encoded aocoin transaction\n" +
            "or:     aocoin-tx [options] -create [commands]   Create hex-encoded aocoin transaction\n" +
            "\n";
