...
const char * const BITCOIN_CONF_FILENAME = "aocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aocoin";
#else
    // Unix
    return pathRet / ".aocoin";
#endif
#endif
}
