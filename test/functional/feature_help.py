...
"""Verify that starting aocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aocoin with -h for help text")
        ...
        self.log.info("Start aocoin with -version for version information")
        ...
        self.log.info("Start aocoind with -fakearg to make sure it does not start")
